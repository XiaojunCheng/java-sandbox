...
public class SandboxServiceImpl implements SandboxService {
    ...
    protected Map<String, SandboxContext> registeredContexts = new Hashtable<>();

    protected JvmPool jvmPool;

    private Set<SandboxHandler> handlers = new HashSet<>();
    ...
    public SandboxServiceImpl(
        ...
        monitorQueue = new ConcurrentLinkedQueue<>();
        startMonitorDaemon();
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#getManager()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#isActive()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#restrict()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#restrict(java.lang.String, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#shutdownJvmPool()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#restartJvmPool()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxService#isRestricted()
     */
    @Override
     ...
     */
    @Override
    public SandboxClassLoader initClassLoader(String restrictSet) {
     ...
     */
    @Override
    public SandboxClassLoader initClassLoader(SandboxContext restrictSet) {
     ...
     */
    @Override
    public SandboxClassLoader initClassLoader(ClassLoader loader, String context) {
     ...
     */
    @Override
    public SandboxClassLoader initClassLoader(ClassLoader loader, SandboxContext context) {
        SandboxClassLoader sandboxLoader = new SandboxClassLoader(loader);
    ...
    public <V> SandboxedCallResult<V> runSandboxed(Class<? extends SandboxedEnvironment> call, SandboxContext context, Object... args) {
        SandboxClassLoader loader = initClassLoader(context);
    ...
    protected <V> SandboxedCallResult<V> run(Class<? extends SandboxedEnvironment> call,
        ...
        try {
            ...
            return new SandboxedCallResultImpl<>(result);
        } catch (Exception e) {
