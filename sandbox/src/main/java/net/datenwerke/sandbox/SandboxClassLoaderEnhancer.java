 ...
 */
public interface SandboxClassLoaderEnhancer {
     ...
     * @param resolve
     */
    void classToBeLoaded(SandboxClassLoader sandboxLoader, String name, boolean resolve);
     ...
     * @return
     */
    byte[] loadClass(SandboxClassLoader sandboxLoader, String name);
     ...
     * @return
     */
    byte[] enhance(SandboxClassLoader sandboxLoader, String name, byte[] cBytes);
     ...
     * @param clazz
     */
    void classLoaded(SandboxClassLoader sandboxLoader, String name, Class clazz);
