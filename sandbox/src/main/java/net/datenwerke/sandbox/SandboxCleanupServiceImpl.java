...
public class SandboxCleanupServiceImpl implements SandboxCleanupService {
     ...
     * (non-Javadoc)
     *
     * @see net.datenwerke.sandbox.SandboxCleanupService#kill(net.datenwerke.sandbox.SandboxMonitoredThread, net.datenwerke.sandbox.exception.SandboxedTaskKilledException)
     */
    @Override
