 ...
 * configuration for the classloader ({@link SandboxClassLoader}) as well as
...
public class SandboxContext implements Serializable {
     ...
     * sandbox loader
     **/
    private Collection<URL> jarsForApplicationLoader = new HashSet<>();
    private Collection<String> classPrefixesForApplicationLoader = new HashSet<>();
    private Collection<String> classesForApplicationLoader = new HashSet<>();

    private Collection<String> classPrefixesForSandboxLoader = new HashSet<>();
    private Collection<String> classesForSandboxLoader = new HashSet<>();

    private Map<URL, SandboxContext> subLoaderContextByJar = new HashMap<>();
    private Map<String, SandboxContext> subLoaderContextByClass = new HashMap<>();
    private Map<String, SandboxContext> subLoaderContextByClassPrefix = new HashMap<>();

    private String codesource;

    private SandboxClassLoaderEnhancer loaderEnhancer;
     ...
     * permissions
     */
    private Map<String, Collection<SecurityPermission>> permissionWhitelist = new HashMap<>();
    private Map<String, Collection<SecurityPermission>> permissionBlacklist = new HashMap<>();

    private Collection<String> classPrefixWhitelist = new HashSet<>();
    private Collection<String> classPrefixBlacklist = new HashSet<>();
    private Collection<String> classBlacklist = new HashSet<>();
    private Collection<String> classWhitelist = new HashSet<>();
    private Collection<ClassPermission> complexClassWhitelist = new HashSet<>();

    private Collection<String> packagePrefixWhitelist = new HashSet<>();
    private Collection<String> packagePrefixBlacklist = new HashSet<>();
    private Collection<String> packageWhitelist = new HashSet<>();
    private Collection<String> packageBlacklist = new HashSet<>();
    private Collection<PackagePermission> complexPackageWhitelist = new HashSet<>();

    private Collection<FilePermission> fileReadPermissions = new HashSet<>();
    private Collection<FilePermission> fileReadDenials = new HashSet<>();

    private Collection<FilePermission> fileWritePermissions = new HashSet<>();
    private Collection<FilePermission> fileWriteDenials = new HashSet<>();

    private Collection<FilePermission> fileDeletePermissions = new HashSet<>();
    private Collection<FilePermission> fileDeleteDenials = new HashSet<>();

    private Collection<URL> whitelistedJars = new HashSet<>();
    ...
    public SandboxContext(boolean initDefault) {
        if (initDefault) {
            ...
            addSecurityPermission(AccessType.DENY, new SecurityPermission("java.lang.reflect.SuppressAccessCheckPermission", "net.datenwerke.sandbox.SandboxClassLoader"));
            addSecurityPermission(AccessType.DENY, new SecurityPermission("java.lang.reflect.AccessDeclaredMemberPermission", "net.datenwerke.sandbox.SandboxClassLoader"));
        }
    }
     ...
     * @param clazz
     * @param context
     * @see SandboxClassLoader#doGetSubLoaderByClassContext(String)
     * @see SandboxClassLoader#getSubloaderByName(String)
     */
     ...
     */
    public void setLoaderEnhancer(SandboxClassLoaderEnhancer loaderEnhancer) {
     ...
     * @return
     */
    public SandboxClassLoaderEnhancer getLoaderEnhancer() {
     ...
     * by the {@link SandboxClassLoader} to specifiy codesource (unless
    ...
    /**
     * @return The codesource used by {@link SandboxClassLoader} when loading classes in this context.
    ...
    /**
     * Sets the codesource that is to be used by {@link SandboxClassLoader} when loading classes in this context.
     *
     * @param codesource
     */
    ...
    /**
     * Enable/Disable whether the {@link SandboxClassLoader} is to remove finalizers from loaded classes.
     * <p>
    ...
    /**
     * Adds the {@link SandboxClassLoader}'s default Codesource prefix to be read accessible for
     * sandboxed code.
     *
     * @see SandboxClassLoader#DEFAULT_CODESOURCE_PREFIX
     */
    public void addDefaultCodesourcePrefix() {
        addFilePermission(FileAccess.READ, AccessType.PERMIT, new FilePrefixPermission(SandboxClassLoader.DEFAULT_CODESOURCE_PREFIX));
    }
